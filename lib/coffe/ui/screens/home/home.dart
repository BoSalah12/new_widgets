import '../../../ui/data/dummy_data.dart';
import '../../../ui/data/models.dart';
...
class CoffeHomePage extends StatefulWidget {
  ...
  @override
  CoffeHomePageState createState() => CoffeHomePageState();
}

List<int> itemsBreakPoints = [0, 3, 5, 7, 9];

class CoffeHomePageState extends State<CoffeHomePage> {
  int selectedIndex = 0;
